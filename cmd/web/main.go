...
// One thing to understand is that the API in itself will run concurently.
// Therefore, it it blazingly fast but the problem is that you may encounter race condition.
